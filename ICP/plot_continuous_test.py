...
# Load data npy file
points1 = np.load("/home/laser14/Documents/Personal/RPLidar/ICP/test_data/test.npy", allow_pickle=True)

for point in points1:
    plt.plot(point[0], point[1], 'o', label='Q: Scan 1', markersize=1)
    plt.pause(0.5)
    plt.clf()
    # plt.show()
print()
